...
| `lorcana_import_duels_history` | Import the duels.ink account-ledger CSV (complete record; upsert on game_id, auto-links logged rounds by lore fingerprint, reports unresolved/unmapped/ambiguous). |
