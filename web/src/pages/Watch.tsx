      ...
      {data.lists.map((wl) => (
        <div className="panel" key={wl.list_id}>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table>
              <thead>
                <tr><th>Card</th><th>Rarity</th><th style={{ textAlign: 'right' }}>Price</th>
                  <th style={{ textAlign: 'right' }}>7d</th><th>CI</th><th>mv</th>
                  <th style={{ textAlign: 'right' }}>Ask</th><th>$/wk</th><th>Signal</th></tr>
              </thead>
              <tbody>
                {wl.cards.map((c) => (
                  <tr key={c.card_id}>
